  ...
  <div class="form_label">
    ...
    <div class="multiselect_block">
      <label for="select-1" class="field_multiselect"
        ...
        <button
          @click.self="removeOption(selectedOption)"
          type="button"
...
export default {
  ...
  methods: {
    ...
    removeOption(optionName) {
      for (let option of this.$refs.selectRef.options) {
    ...
    setActiveOptions() {
      ...
      for (let option of this.$refs.selectRef.options) {
        if (option.selected === true) {
          activeOptions.push(option.value);
        }
      }
      this.selectedOptions = activeOptions;
      this.$emit("input", activeOptions);
    },
  },
};
</script>
